...
pub extern var v4l2_log_file: [*c]FILE;
pub extern fn v4l2_open(file: [*c]const u8, oflag: c_int, ...) c_int;
pub extern fn v4l2_close(fd: c_int) c_int;
pub extern fn v4l2_dup(fd: c_int) c_int;
pub extern fn v4l2_ioctl(fd: c_int, request: c_ulong, ...) c_int;
pub extern fn v4l2_read(fd: c_int, buffer: ?*anyopaque, n: usize) isize;
pub extern fn v4l2_write(fd: c_int, buffer: ?*const anyopaque, n: usize) isize;
pub extern fn v4l2_mmap(start: ?*anyopaque, length: usize, prot: c_int, flags: c_int, fd: c_int, offset: i64) ?*anyopaque;
pub extern fn v4l2_munmap(_start: ?*anyopaque, length: usize) c_int;
